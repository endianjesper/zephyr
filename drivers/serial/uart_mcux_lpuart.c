...
static int mcux_lpuart_configure_init(struct device *dev,
...
static int mcux_lpuart_config_get(struct device *dev, struct uart_config *cfg)
{
	struct mcux_lpuart_data *data = dev->data;
...
static int mcux_lpuart_configure(struct device *dev,
				 const struct uart_config *cfg)
{
	const struct mcux_lpuart_config *config = dev->config;
